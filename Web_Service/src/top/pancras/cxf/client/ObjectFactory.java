 ...
 * generated in the top.pancras.cxf.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCity_QNAME = new QName("http://service.cxf.pancras.top/", "getWeatherByCity");
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://service.cxf.pancras.top/", "getWeatherByCityResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: top.pancras.cxf.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf.pancras.top/", name = "getWeatherByCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf.pancras.top/", name = "getWeatherByCityResponse")
