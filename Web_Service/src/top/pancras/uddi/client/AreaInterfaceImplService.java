 ...
 * 
 */
@WebServiceClient(name = "AreaInterfaceImplService", targetNamespace = "http://service.uddi.pancras.top/", wsdlLocation = "http://127.0.0.1:12345/area?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AREAINTERFACEIMPLSERVICE_QNAME = new QName("http://service.uddi.pancras.top/", "AreaInterfaceImplService");
    ...
    public AreaInterfaceImpl getAreaInterfaceImplPort() {
        return super.getPort(new QName("http://service.uddi.pancras.top/", "AreaInterfaceImplPort"), AreaInterfaceImpl.class);
    }
    ...
    public AreaInterfaceImpl getAreaInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.uddi.pancras.top/", "AreaInterfaceImplPort"), AreaInterfaceImpl.class, features);
    }
