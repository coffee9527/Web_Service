 ...
 * generated in the top.pancras.webservice.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCity_QNAME = new QName("http://webservice.pancras.top/", "getWeatherByCity");
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://webservice.pancras.top/", "getWeatherByCityResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: top.pancras.webservice.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.pancras.top/", name = "getWeatherByCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.pancras.top/", name = "getWeatherByCityResponse")
